...
render(colors = ["gray","gray","gray"], money = this.wallet.getWalletWalue(), result = "", stats = [0,0,0], bid = 0, wonMoney = 0) {
// console.log('Gramy');
...
startGame() {
    ...
    this.render(colors, this.wallet.getWalletWalue(), win, this.stats.showGameStatistics(), bid, wonMoney)
}
